          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th class="col-md-2">Nacionalidade</th>
                <th class="col-md-1">Camisa</th>
                <th class="text-center col-md-1">Alterar</th>
                <th class="text-center col-md-1">Excluir</th>
              </tr>
              <?php foreach($usersJ as $userJ) { ?>
              <tr>
                <td><?=$userJ[0]?></td>
                <td><?= date('d/m/Y', strtotime($userJ[2]));?></td>
                <td><?=$userJ[1]?></td>
                <td><?=$userJ[3]?></td>
                <td><?=$userJ[4]?></td>
                <td><?=$userJ[5]?></td>
                <td class="text-center">
                  <form action="process.php" method="POST">
                    ...
                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$userJ[0]?>">
                ...
                <td class="text-center ">
                  <a class="dropdown-item" onclick="modalRemover(<?=$userJ[0]?>,'idDeletar')">
